...
**8 of 8 families fall below ~150 events/year:** opening_range_up, vwap_reclaim_down, ib_extension_down, ib_extension_up, prior_day_high, vwap_reclaim_up, opening_range_down, prior_day_low. `CLAUDE.md` §6 asks for the count and leaves the decision with the principal:
